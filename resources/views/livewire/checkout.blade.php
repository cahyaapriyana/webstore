        ...
        <div class="grid gap-5 md:gap-20 md:grid-cols-2">
            <div class="p-10">
                        ...
                        <div>
                            <div x-data="{ open: false }" class="relative w-full">
                                ...
                                <input type="text"
                                    ...
                                    <div wire:loading wire:target="region_selector.keyword" class="absolute right-3 top-3 animate-spin inline-block size-4 border-3 border-current border-t-transparent text-blue-500 rounded-full dark:text-blue-500" role="status" aria-label="loading">
                ...
                <div class="mt-2 space-y-3">
                    ...
                    <div wire:loading wire:target="region_selector.region_selected" class="animate-spin inline-block size-4 border-3 border-current border-t-transparent text-blue-500 rounded-full dark:text-blue-500" role="status" aria-label="loading">
                        <span class="sr-only">Loading...</span>
                    </div>
                    </div>
            ...
            <div class="p-10">
                ...
                <div class="grid gap-5">
                        ...
                        <li
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <span class="relative">
                                    ...
                                    <div wire:loading wire:target="shipping_selector.shipping_method" class="absolute right-3 top-3 animate-spin inline-block size-4 border-3 border-current border-t-transparent text-blue-500 rounded-full dark:text-blue-500" role="status" aria-label="loading">
                                        <span class="sr-only">Loading...</span>
                                    </div>
                                </span>
                    ...
                    <!-- End List Group -->
                    <button type="button" wire:click="placeAndOrder()"
